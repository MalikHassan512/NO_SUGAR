...
export default function WaterGoal() {
  ...
  return (
    <>
      ...
      <View style={{height: 50, backgroundColor: '#1b95e0'}}></View>
      <ScrollView style={{
            flex: 0.9,
          ...
          <View
            ...
            <View style={{margin: 10}}>
              <ProgressCircle
                percent={
                  ((goalValue?.Water?.Done || 0) /
                    (goalValue?.Water?.Target || 8)) *
                  100
                }
                radius={80}
                borderWidth={12}
            ...
            <View style={{justifyContent: 'center', marginRight: 20}}>
              ...
              <Text style={{color: 'grey', marginBottom: 20}}>Glasses</Text>
              <Text style={{fontSize: 22, fontWeight: 'bold'}}>
                {goalValue?.Water?.Target * 0.25 || 2}
              </Text>
              <Text style={{color: 'grey'}}>Liters</Text>
            </View>
          </View>
          ...
          <LinearGradient
            ...
            colors={['#1b95e0', '#1b95e0']}>
            <TouchableOpacity
              onPress={() =>
                guest
                  ? setAuthVisible(true)
                  : navigation.navigate('WaterIntake', {code: 'goal'})
              }>
              <View style={styles.loginContainer}>
                {/* {isLoading ? <ActivityIndicator color="white" /> : null} */}
                <Text style={styles.loginTouch}>SET UP YOUR WATER GOAL</Text>
              </View>
            </TouchableOpacity>
          </LinearGradient>
          <Chart color="27, 149, 224" code="Water" name="Water History" />

          <Text style={styles.IntakeList}>Water Intake List</Text>
            ...
            details[0].map((item, index) => (
              <View key={index}>
                <View style={styles?.listingContainer}>
                  ...
                  <Text maxLength={20} style={{width: 110}}>
                    {item?.detail?.quantity} Glasses
                  </Text>
      ...
      <LinearGradient
        ...
        <TouchableOpacity
          onPress={() =>
            guest ? setAuthVisible(true) : navigation.navigate('WaterIntake')
          }>
