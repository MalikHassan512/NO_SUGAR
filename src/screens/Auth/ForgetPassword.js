...
const ForgetPassword = () => {
  ...
  const codeRequest = async values => {
    setIsLoading(true);
    try {
      await axios.post(`${url}forgot-password/`, values);
        ...
        <KeyboardAvoidingView style={{flex: 1}} behavior="padding">
          <Card style={styles.loginView}>
            ...
            <Formik
              ...
              onSubmit={values => codeRequest(values)}>
                  ...
                  <LinearGradient
                    ...
                    <TouchableOpacity onPress={handleSubmit}>
                      <View style={{flexDirection: 'row', alignSelf: 'center'}}>
                        ...
                        <Text style={styles.loginTouch}>Request Code</Text>
                      </View>
                    </TouchableOpacity>
                  </LinearGradient>
                </View>
